...
<div class="card card-block" style="width:40rem;">
          ...
          <div class="card-body">
            <h4 class="card-title display-4"><p><h2 class="text-left text-white bg-dark">FUTSALHUB Info</h2></p>
            <p class="card-text"> 
              <div class="justify-content-center"><p>Name: FUTSALHUB</p></div>
  ...
  <div class="container container-fluid">
               <?php
                 while($row = mysqli_fetch_assoc($result)){
                  $cardtile=$row['card_title'];
                  $cardshrt=$row['card_text_short'];
                  $img=$row['Images'];
                  $cardshrt=$row['card_text_long'];
                  $dbdate=$row['date'];
                 ?>
    ...
    <div class="row">
        ...
        <img class="card-img-top" src="<?php echo $img;?>" alt="Card image" style="width:100%">
          <div class="card-body">
            <h4 class="card-title"><?php echo $cardtile;?></h4>
            <p class="card-text"> 
              <?php echo $cardshrt;?>
            </p>
      ...
      <div class="col-md-4  d-flex pb-3 text-center">
        <div class="card card-block" style="width:400px">
          ...
          <div class="card-body">
            ...
            <a href="futsalevent.php" class="btn btn-primary">See Profile</a>
          </div>
        </div>
      ...
      <div class="col-md-4  d-flex pb-3 text-center">
        <div class="card card-block" style="width:400px">
          ...
          <div class="card-body">
            ...
            <p class="card-text"> 
              Futsal is alway s looking for ways to promote Bermudian football and futsal locally and Internationally.
            </p>
            <a href="sportsmarketing.php" class="btn btn-primary">See Profile</a>
          </div>
        </div>
      ...
      <div class="col-md-4  d-flex pb-3 text-center">
       ...
       <div class="card card-block" style="width:400px">
        ...
        <div class="card-body">
          ...
          <a href="playerdevelopment.php" class="btn btn-primary">See Profile</a>
        </div>
      </div>
